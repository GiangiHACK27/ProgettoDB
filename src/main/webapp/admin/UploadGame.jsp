...
<body>
	...
	<form action="/GamingWorldShop/admin/GameUploadServlet" method="post"
		...
		<fieldset>
			...
			<input type="file" id=showcaseImages name=showcaseImages multiple=multiple accept="image/jpeg, image/png, image/jpg"> 
			<br> 
			...
			<br> 
			Price:
			<input type="number" min="0" max="10000" step="0.1" name="price" /><br>
